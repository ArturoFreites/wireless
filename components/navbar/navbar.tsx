...
function NavBar() {
    return (
        <nav className="fixed top-0 w-full z-50 shadow-md">
            <Advertisements />
            <div className="bg-white h-14 px-10 flex items-center justify-between w-full flex-col md:flex-row">
                <div className="w-full flex justify-center h-full md:w-1/8">
