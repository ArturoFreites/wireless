...
function DashboardClient() {
    ...
    return (
        <article className="w-full text-neutral-800 p-4 md:p-6">
            ...
            <div className="flex items-center justify-between mb-4 flex-col md:flex-row">
                ...
                <div className="flex gap-2 font-semibold flex-col md:flex-row mt-10">
                    <button
            ...
            {loading ? (
                ...
                <div className="w-full overflow-x-auto border border-neutral-300 rounded-md shadow-sm">
                    <div className="max-h-[75vh] overflow-y-auto">
                        <table className="w-full min-w-[1000px] text-sm">
                            <thead className="sticky top-0 bg-white shadow-sm z-10 text-xs">
